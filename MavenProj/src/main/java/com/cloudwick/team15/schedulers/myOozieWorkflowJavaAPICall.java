...
public static void main(String[] args) {
    ...
    conf.setProperty(OozieClient.APP_PATH, "hdfs://cdh-nn01.hadoop.com:8020/user/hdoop//workflow.xml");
    conf.setProperty("jobTracker", "localhost:8021");
    conf.setProperty("nameNode", "hdfs://localhost:8020");
    conf.setProperty("queueName", "default");
    conf.setProperty("oozie.libpath", "hdfs://cdh-nn01.hadoop.com:8020/user/hdoop/share/lib");
